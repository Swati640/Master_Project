...
parser.add_argument('-m', '--metric', type=str, required=False, choices=['tvsum', 'summe'],
...
parser.add_argument('--lr', type=float, default=1e-03, help="learning rate (default: 1e-05)")
...
def main():
    ...
    optimizer = torch.optim.ASGD(model.parameters(), lr=args.lr, weight_decay=args.weight_decay)
    if args.stepsize > 0:
